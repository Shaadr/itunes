angular.module('itunes').controller('mainCtrl', function($scope, itunesService){
  //This is setting up the default behavior of our ng-grid.
  //The important thing to note is
  //the 'data' property. The value is 'songData'.
  //That means ng-grid is looking for songData on $scope and is putting
  //whatever songData is into the grid.
  //this means when you make your iTunes request,
  //you'll need to get back the information, parse it accordingly,
...
$scope.getSongData();
  ...
  //Now write a function that will call the method on the itunesService
  //that is responsible for getting the data from iTunes,
  ...
  //head over there and check if that input box is tied to any
